...
$(function () {
  $.get("https://rawgit.com/aurangzaib/master-project/master/listnride.css", function (listnRideCss) {
    $.get("https://code.getmdl.io/1.2.1/material.blue_grey-blue.min.css", function (mdlCss) {
      $.get("https://fonts.googleapis.com/icon?family=Material+Icons", function (mdlFonts) {
