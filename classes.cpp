...
someClass::someClass(int x, int y)
    : property1(x), property2(y), otherClassProperty(5) {
  property3 = 5;
}
// member initialization of ctor
someClass::someClass(int x, int y, int z)
    : property1(x), property2(y), property3(5), otherClassProperty(z){};
...
int someClass::getProperties(void) { return property1; }

SomeOtherClass someClass::getOtherProperty(void) { return otherClassProperty; }
