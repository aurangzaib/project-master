...
void sobelCannyThreshold () {
    ...
    src = imread(masterproject::prjdir+"/Meeting-2/1-dark.bmp", CV_LOAD_IMAGE_COLOR );
    ...
    // write to disk
    imwrite(masterproject::prjdir + "/Meeting-2/1-dark-grey.bmp", grey); // save as grey image
    imwrite(masterproject::prjdir + "/Meeting-2/1-dark-grey.bmp", sobelx); // save as grey image
    imwrite(masterproject::prjdir + "/Meeting-2/1-dark-grey.bmp", canny); // save as grey image
	imwrite(masterproject::prjdir + "/Meeting-2/1-dark-threshold.bmp", thresholdImage); // save as grey image
