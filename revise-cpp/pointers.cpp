...
void playWithPointers () {
    ...
    *pointToSecondValue = *pointToFirstValue; // firstValue and secondValue have same value
...
void playWithPointerAndArray() {
    ...
    // cout << *(pointToArray++) << endl; --> increment address but show previous value
    // cout << *(++pointToArray) << endl; --> increment address then show new value
    // cout << *(pointToArray+1) << endl; --> increment address then show new value
...
void playWithPointerToPointer () {
    ...
    // its possible that a pointer points to a pointer which in turn points to a variable
    int a = 4;
    int *b = &a;
    int **c = &b;
